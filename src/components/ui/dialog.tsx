...
>(({ className, children, ...props }, ref) => {
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        isFullscreen
          ? "fixed top-0 left-0 right-0 z-50 flex flex-col bg-background data-[state=open]:animate-dialog-slide-from-right data-[state=closed]:animate-dialog-slide-to-left"
